...
content = content.replace(/                      \) : \(\r?\n                        <p \r?\n                          className="font-mono text-sm font-bold text-brand-cyan cursor-pointer hover:bg-slate-800 \r?\npx-2 py-1 rounded transition-colors"[\s\S]*?                      \}/, replacePromptBlock);
