          ...
          <div className="bg-slate-900/80 border border-slate-800 rounded-3xl p-8 backdrop-blur-xl shadow-2xl">
            <div className="text-center mb-8">
              ...
              <h1 className="text-2xl font-bold font-title uppercase tracking-wider text-white">
                {resolvedParams.locale === 'en' ? 'Client Portal' : 'Portal de Clientes'}
              </h1>
              <p className="text-slate-400 text-sm mt-2">
                {resolvedParams.locale === 'en' 
                  ? 'Access your orders, quotes, and engineering projects.' 
                  : 'Accede a tus pedidos, cotizaciones y proyectos de ingeniería.'}
              </p>
            </div>

            <LoginForm locale={resolvedParams.locale} />
          </div>
        </div>
      </main>
